...
public:
	void changePoint(int segIndx, glm::vec3 newP0);
	Bezier1D(int segNum, int res,int mode, std::vector<glm::mat4> mat, int viewport = 0);
	void updateIndx(int segIndx, glm::mat4);
